/* @ts-self-types="./komment.d.ts" */

export class Komment {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KommentFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_komment_free(ptr, 0);
    }
    /**
     ...
     * @returns {Promise<any>}
     */
    create_discussion(repo_owner, repo_name, category_name, title, body) {
        const ptr0 = passStringToWasm0(repo_owner, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(repo_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ret = wasm.komment_create_discussion(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
        return ret;
    }
    /**
    ...
    delete_comment(comment_id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.komment_delete_comment(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @returns {Promise<any>}
     */
    fetch_discussion() {
        const ret = wasm.komment_fetch_discussion(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {any} config
     */
    constructor(config) {
        const ret = wasm.komment_new(config);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        KommentFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @returns {Promise<any>}
     */
    post_comment(discussion_id, body) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.komment_post_comment(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
    ...
    update_comment(comment_id, body) {
        ...
        const ptr1 = passStringToWasm0(body, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.komment_update_comment(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
}
if (Symbol.dispose) Komment.prototype[Symbol.dispose] = Komment.prototype.free;
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_c072c4ce9a2a0cdf: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h28b7bbeccbc6f8b7(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hf39fca293b0a8846);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./komment_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__hf39fca293b0a8846(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__hf39fca293b0a8846(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h28b7bbeccbc6f8b7(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h28b7bbeccbc6f8b7(arg0, arg1, arg2, arg3);
}


const __wbindgen_enum_RequestMode = ["same-origin", "no-cors", "cors", "navigate"];
const KommentFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_komment_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('komment_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
